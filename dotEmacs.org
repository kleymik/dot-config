...
(defun insertTreeCalcSexp ()
   "Eval expression and insert value after the expression"
    ...
    (save-excursion
        ...
        (cond ((setq result-bgn (search-forward-regexp "\(.[ \t]+;=" (line-end-position) nil))          ; goto jusr after "<operator><space>;="
               (cond ((setq result-end (search-forward-regexp " ;;;" (line-end-position) nil))          ; goto just after "<triple-semi-colon>"
...
(setq max-lisp-eval-depth1200) ; 800
