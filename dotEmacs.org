...
; ----------------------- dired etc
(load-file "/home/kleyn/ulib/emacs/diredPlus.el") ;(require 'dired+)  ; my fixed version (require 'diredPlus)
(require 'dired-x)
(require 'wdired)
...
(setq org-src-fontify-natively t)   ;;(setq org-checkbox-bullets '("J" "X"))  ;; Doesn't work ??J=done and X=tbd 20240326_11:55:41 
...
;(load-file "/home/kleyn/ulib/emacs/diredPlus.el")
