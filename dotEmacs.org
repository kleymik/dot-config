...
(defun see-doAndDone()          (interactive) (find-file "/home/kleyn/aNotes/doAndDone.org"))
...
(global-set-key [f2]            'see-doAndDone)
(global-set-key [f3]            'diredHome)                 ;; mk-new-buffer
(global-set-key [f4]            'see-dotEmacs)              ;; nok900  'my-openfile  'neotree-show
