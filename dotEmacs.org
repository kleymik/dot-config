...
#+END_SRC
   ;; (define-key emacs-lisp-mode-map [kp-4]        '(lambda () (interactive)  (outline-up-heading 2)))
   ;; (define-key emacs-lisp-mode-map [kp-8]        'my-org-babel-prev)
   ;; (define-key emacs-lisp-mode-map [kp-2]        'my-org-babel-next)
   ;; (define-key emacs-lisp-mode-map [kp-multiply] '(lambda () (interactive)  (org-backward-heading-same-level 6)))
   ;; (define-key emacs-lisp-mode-map [kp-6]        'org-cycle)
   ;; (define-key emacs-lisp-mode-map [kp-decimal]  '(lambda () (interactive)  (org-forward-heading-same-level 6)))
...
(progn ;; dired treepad navigation
  ...
  (define-key dired-mode-map [C-kp-add]         'dired-find-file)
)
; ------------------------------------------------------------------ TreeNavPad keys for dired
