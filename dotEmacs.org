...
(blink-cursor-mode 0)
(set-cursor-color "#669966")  ; also at end of init.el, after theming 
...
** Dired/Sidebar/filetree/neotree Mode
...
;(global-set-key [f3]       'ibuffer-sidebar-toggle-sidebar)
...
(global-set-key [f4]       '(lambda () (interactive)  (dired "~/")))
...
(defun sb ()
 (progn
  ...
  (add-to-list 'eshell-command-aliases-list (list "cl"    "cd $*; ls -l"))
  ...
  (add-to-list 'eshell-command-aliases-list (list "fg"    "~/ubin/rgrep.py $*"))
