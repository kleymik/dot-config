...
(defun bool-flip-do-flip ()
  ...
  (let ((currWord (thing-at-point 'word))
    ...
    (setq flippedWord (cond ((equal word "1")     "0")
                            ((equal word "0")     "1")
                            ((equal word "Yes")   "No")
                            ((equal word "No")    "Yes")
                            ((equal word "False") "True")
                            ((equal word "True")  "False")))
    (save-excursion
...
|-------+----------+------------+--------------+-----------+---+----------+-----------+----+----+---+-------------+-----------+--------------+-----+-------|
|       | *eshell* | doAnDone   | dired ~/     | dotEmacs  |   | app-open | transpose |    |    |   | macro-start | tog node  | tog py break |     |       |
| CTRL  | *bash*   | bookmarks  | dired-omit   | transpose |   | fapp     | bool-flip |    |    |   | macro-go    | tog all   | debug-off    |     | CTRL  |
| SHIFT | *python* | scratch    | dired repos/ |           |   |          |           |    |    |   | macro-end   | open all  | debug-on     |     | SHIFT |
| ALT   | *ielm*   | mySystems? | dired hist/  |           |   |          |           |    |    |   |             | yafolding |              |     | ALT   |
| SUPER | *ansi*?  | access?    |              |           |   |          |           |    |    |   |             |           |              |     | SUPER |
|-------+----------+------------+--------------+-----------+---+----------+-----------+----+----+---+-------------+-----------+--------------+-----+-------|
#+BEGIN_SRC emacs-lisp
...
(global-set-key [M-f2]          '(lambda () (interactive) (find-file "/home/kleyn/aNotes/mySystems.org")))
...
(global-set-key [f4]            '(lambda () (interactive) (find-file "/home/kleyn/.emacs.d/dotEmacs.org") (search-forward "** Function Keys") (org-show-subtree)))             ;; nok900  'my-openfile  'neotree-show
