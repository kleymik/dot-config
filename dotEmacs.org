...
(setq dired-listing-switches "-alht --time-style=long-iso") ;; list most recent first
...
|-------+----------+------------+--------------+-----------+---+----------+--------------+---------+----+---+-------------+-----------+--------------+-----+-------|
|       | *eshell* | doAnDone   | dired ~/     | dotEmacs  |   | app-open | transpose    | buffers |    |   | macro-start | tog node  | tog py break |     |       |
| CTRL  | *bash*   | mySystems  | dired-omit   | dotBashrc |   | fapp     | bool-flip    |         |    |   | macro-go    | tog all   | debug-off    |     | CTRL  |
| SHIFT | *python* | scratch    | dired repos/ | buffers   |   |          | toggle-trunc |         |    |   | macro-end   | open all  | debug-on     |     | SHIFT |
| ALT   | *ielm*   |            | dired hist/  |           |   |          |              |         |    |   |             | yafolding |              |     | ALT   |
| SUPER | *ansi*?  | access     | filepath     |           |   |          |              |         |    |   |             |           |              |     | SUPER |
|-------+----------+------------+--------------+-----------+---+----------+--------------+---------+----+---+-------------+-----------+--------------+-----+-------|
#+BEGIN_SRC emacs-lisp
...
(global-set-key [M-f1]          'ielm) ;; open file under cursor ;;(global-set-key [M-f9] 'insertLastSexp) ;; insert result
...
(global-set-key [S-f2]          '(lambda () (interactive) (find-file "/home/kleyn/aNotes/mySystems.org")))
(global-set-key [M-f2]          '(lambda () (interactive) (find-file "/home/kleyn/aNotes/bookmarks.org")))
(global-set-key [s-f2]          '(lambda () (interactive) (find-file "/home/kleyn/aNotes/access.org")))

(global-set-key [f3]            'diredHome)
(global-set-key [C-f3]          'dired-omit-mode)
(global-set-key [S-f3]          '(lambda () (interactive) (dired "~/projects/repos" nil)))
(global-set-key [M-f3]          '(lambda () (interactive) (dired "~/history/commands/*2020*" nil)))
(global-set-key [s-f3]          '(lambda () (interactive) (filepath-on-clipboard)))

(global-set-key [f4]            '(lambda () (interactive) (ibuffer "home") (ibuffer-switch-to-saved-filter-groups "home")))
(global-set-key [C-f4]          '(lambda () (interactive) (find-file "/home/kleyn/.emacs.d/dotEmacs.org") (search-forward "** Function Keys") (org-show-subtree)))     ;; nok900  'my-openfile  'neotree-show
(global-set-key [S-f4]          '(lambda () (interactive) (find-file "/home/kleyn/config/dot/dotBashrc") ))                                                            ;; nok900  'my-openfile  'neotree-show
(global-set-key [C-f4]          'insertLastSexp)                                                                                                                       ;; (lambda () (interactive) (dired "C:/[pm][rya][qoadmp][parsd]*" nil)))
...
(global-set-key [f7]            '(lambda () (interactive) (ibuffer "home") (ibuffer-switch-to-saved-filter-groups "home")))
...
(global-set-key [f11]           'insertcodePyCodeSnippet)
(global-set-key [C-f11]         'set-debug-on)
(global-set-key [S-f11]         'set-debug-off)
...
(global-set-key [C-kp-4]        'selective-display-level-decr)
(global-set-key [C-kp-5]        'selective-display-level-zero)
(global-set-key [C-kp-6]        'selective-display-level-incr)
